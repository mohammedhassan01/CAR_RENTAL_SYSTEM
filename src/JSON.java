...
public class JSON {
	public static JSONObject toJSON(Object input) throws IllegalAccessException, InstantiationException {
		...
		for (Field curField : fields) {
			...
			if (curField.getType().isArray()) {
				// First, check if this is an optional field that doesn't exist.
				// If so, ignore it
				if (annotation.optional() && curField.get(input) == null) {
					continue;
				}

				// Handling an array requires us to allocate the array, stuff
				// each index into the array, and set the results at the end
	...
	private static Object toJSONField(Object input, Field curField)
			throws IllegalAccessException, InstantiationException {
		String fieldType = curField.getType().getName();
		curField.setAccessible(true);

		// See if this is annotated as an optional member. If it is, return NULL
		// if it does not exist
		// Otherwise the use of getXXX below will throw an exception on
		// non-existance
		JSONField annotation = (JSONField) curField.getAnnotation(JSONField.class);
		/*
		 * if(annotation == null){ return null; } if(annotation.optional() &&
		 * curField.get(input) == null){ return null; }
		 */
		if (fieldType.equals("java.lang.Boolean") || fieldType.equals("java.lang.Double")
				|| fieldType.equals("java.lang.Integer") || fieldType.equals("java.lang.Long")
	...
	private static Object toJSONArrayIndex(Object curObject) throws IllegalAccessException, InstantiationException {
		...
		if (baseTypeName.equals("java.lang.Boolean") || baseTypeName.equals("java.lang.Double")
				|| baseTypeName.equals("java.lang.Integer") || baseTypeName.equals("java.lang.Long")
				|| baseTypeName.equals("java.lang.String")) {
			return curObject;
		} else {
